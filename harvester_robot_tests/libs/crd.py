...
def wait_for_cr_deleted(group, version, namespace, plural, name, timeout=300):
    """
...
def wait_for_cr_status(group, version, namespace, plural, name, status_field, expected_value, timeout=300):    # NOQA
    """
...
def wait_for_cr_condition(
    ...
    condition_type, condition_status, timeout=300
):
    """
