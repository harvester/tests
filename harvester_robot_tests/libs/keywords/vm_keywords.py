...
class vm_keywords:
    ...
    def wait_for_vm_migration_completed(self, vm_name, target_node, timeout=600):
    ...
    def wait_for_backup_completed(self, vm_name, backup_name, timeout=1800):
