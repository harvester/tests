...
class volume_keywords:
    ...
    def wait_for_volume_running(self, volume_name, timeout=300):
    ...
    def wait_for_volume_attached(self, volume_name, timeout=300):
        """Wait for volume to be attached"""
        logging(f'Waiting for volume {volume_name} to be attached')
        self.volume.wait_for_attached(volume_name, timeout)

    def wait_for_volume_deleted(self, volume_name, timeout=300):
