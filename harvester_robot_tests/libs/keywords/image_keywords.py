...
class image_keywords:
    ...
    def wait_for_image_downloaded(self, image_name, timeout=600):
    ...
    def wait_for_image_ready(self, image_name, timeout=600):
    ...
    def wait_for_image_deleted(self, image_name, timeout=600):
