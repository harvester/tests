...
describe("Create image from Volume", () => {
  const IMAGE_NAME = "volume-export-image";
  const VM_NAME = "volume-export-vm";
  const ANOTHER_VM_NAME = "volume-export-vm-2";
...
describe("Create volume root disk VM Image Form", () => {
  const VOLUME_NAME = "volume-e2e-1";
  ...
  it("Create volume root disk VM Image Form", () => {
    ...
    // delete VOLUME
    volumes.delete("default", VOLUME_NAME);
  });
});
...
/**
  ...
  */
//  describe.only('Edit volume increase size via form', () => {
